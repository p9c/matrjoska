...
func Main(cx *pod.State) (e error) {
	...
	var legacyServer *walletrpc.Server
...
// LoadWallet ...
func LoadWallet(loader *wallet.Loader, cx *pod.State, legacyServer *walletrpc.Server) (e error) {
...
func rpcClientConnectLoop(
	cx *pod.State, legacyServer *walletrpc.Server,
...
func StartChainRPC(config *podopts.Config, activeNet *chaincfg.Params, certs []byte, quit qu.C) (
