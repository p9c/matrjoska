...
func CreateSimulationWallet(activenet *chaincfg.Params, cfg *podopts.Config) (e error) {
...
func CreateWallet(activenet *chaincfg.Params, config *podopts.Config) (e error) {
