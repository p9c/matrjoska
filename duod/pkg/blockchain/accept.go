...
//
// The flags are also passed to checkBlockContext and connectBestChain. See their documentation for how the flags modify
// their behavior. This function MUST be called with the chain state lock held (for writes).
