...
import (
	...
	chainhash2 "github.com/p9c/monorepo/duod/pkg/chainhash"
	gcs2 "github.com/p9c/monorepo/duod/pkg/gcs"
	...
	"github.com/p9c/monorepo/monorepo/duod/pkg/gcs/builder"
...
func storeFilter(
	...
	fh, e := builder.MakeHeaderForFilter((*gcs2.Filter)(f), chainhash2.Hash(*prevHeader))
	if e != nil {
		return e
	}
...
func (idx *CFIndex) ConnectBlock(
	dbTx database.Tx, blk *block.Block,
	...
	f, e := builder.BuildBasicFilter(blk.WireBlock(), prevScripts)
	if e != nil {
		return e
	}
	return storeFilter(dbTx, blk, f, wire.GCSFilterRegular)
}
